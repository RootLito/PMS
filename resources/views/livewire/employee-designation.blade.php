    ...
    <div class="p-6 bg-white rounded-xl shadow">
        <form wire:submit.prevent="save" class="w-full flex flex-col">
            ...
            <div class="w-full flex gap-2">
                <div class="flex-1">
                    <label for="pap" class="block text-sm text-gray-700">
                        PAP
                    </label>
                    <input type="text" id="pap" wire:model.live="pap"
                ...
                <div class="flex-1">
                    <label for="office" class="block text-sm text-gray-700">
                        Office
                    </label>
                    <input type="text" id="office" wire:model.live="office"
                        class="mt-1 block w-full h-10 border border-gray-200 bg-gray-50 rounded-md px-2">
                    @error('office')
                        <span class="text-red-500 text-xs">{{ $message }}</span>
                    @enderror
                ...
                <div class="flex-1 mt-auto">
                    <button type="submit"
                        class="flex-1 w-full bg-slate-700 text-white h-10 rounded-md hover:bg-slate-500 cursor-pointer">
                        Save
                    </button>
                    @if ($errors->any())
                        <span class="text-red-500 text-xs">Error occured</span>
                    @endif
                </div>
            </div>
        </form>
        ...
        <table class="min-w-full table-auto text-sm mt-2">
            <thead class="bg-gray-100 text-left">
                <tr class="border-b border-t border-gray-200">
                    <th class="px-4 py-3 text-nowrap" width="25%">PAP</th>
                    <th class="px-4 py-3 text-nowrap" width="30%">Designation</th>
                    <th class="px-4 py-2 text-nowrap" width="30%">Office</th>
